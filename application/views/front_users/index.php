...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title">Vendors <hr /></h3>
        <!-- END PAGE TITLE-->
        <!-- END PAGE HEADER-->
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-12">
                    ...
                    <div class="table-container">
                        ...
                        <table class="table table-striped table-bordered table-hover " id="users-tbl"
                               data-url="<?php echo site_url('front_users/get_all');?>">
                            <thead>
                            <tr>
