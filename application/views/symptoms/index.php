    ...
    <div class="page-content">
        ...
        <div class="row">
            ...
            <div class="col-md-12" style="margin-bottom: 10px">
                ...
                <a href="<?php echo site_url('symptoms/create'); ?>"
                        ...
                        <?php if( is_array($result) && count($result) > 0 ){?>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a class="btn btn-outline btn-circle btn-sm green" href="<?php echo site_url('symptoms/edit/'.encrypt($row->id));?>"  >
                                        <i class="fa fa-edit"></i> Edit </a>
                                    <a class="btn btn-outline btn-circle btn-sm red" href="<?php echo site_url('symptoms/delete/'.encrypt($row->id));?>" onclick="if(!confirm('Are you sure you want to delete this forever?')) return false;" >
